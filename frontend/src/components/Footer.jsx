const Footer = () => {
  ...
  return (
    ...
    <div className="bg-[#faf7f0]">
      <footer class=" sm:mx-10 rounded-3xl mb-2 bg-[#390F0F] pb-16 ">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 ">
          <div class="md:flex md:justify-between text-white">
            <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                ...
                <span class="text-heading self-center text-2xl font-semibold whitespace-nowrap">VUNÈ</span>
              </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4 ">
              <div>
                <h2 class="mb-6 text-sm font-semibold text-heading uppercase">Shop</h2>
              ...
              <div>
                <h2 class="mb-6 text-sm font-semibold text-heading uppercase">Services</h2>
                <ul class="text-body font-medium">
                  <li class="mb-4">
              ...
              <div>
                <h2 class="mb-6 text-sm font-semibold text-heading uppercase">Trust</h2>
                <ul class="text-body font-medium">
                  <li class="mb-4">
                    <a href="#" class="hover:underline text-white">Privacy Policy</a>
                  </li>
          ...
          {/* <hr class="my-6 border-default sm:mx-auto lg:my-8 text-white"  /> */}

        </div>
      </footer>
      <div className=" flex flex-col sm:flex-row items-center justify-between gap-4 mx-12 sm:mx-10 md:mx-32 pb-10 text-center sm:text-left">

        {/* LEFT TEXT */}
        <span className="text-sm text-black">
          © 2026 <a href="#" className="hover:underline">@Vune</a>. All Rights Reserved.
        </span>
      ...
      {/* <div class="sm:flex sm:items-center justify-between mx-auto sm:mx-32 mb-10">
